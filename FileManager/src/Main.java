...
public class Main {
    ...
    private JList<String> dirList = new JList<String>();
    private JScrollPane tablePane=new JScrollPane();
    private JScrollPane dirlistPane=new JScrollPane();
    
    private JLabel dirLabel=new JLabel();
    private JComboBox<ComboBoxLocale> localeBox=new JComboBox<ComboBoxLocale>();
    ...
    private JTable fileTable=new JTable(contents,header);
    ...
    private Main() {
        ...
        Menu menu = new Menu(this, fileTable, bundle);
    ...
    private void formUI(){
       ...
       dirlistPane=new JScrollPane(dirList);
       basePanel.add(dirlistPane,BorderLayout.WEST);
       basePanel.add(tablePane,BorderLayout.CENTER);
       
       
       bottomPanel.setLayout(new BorderLayout());
       bottomPanel.add(titleLabel,BorderLayout.WEST);
       bottomPanel.add(localeBox, BorderLayout.EAST);
